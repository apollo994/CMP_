...
echo
echo --------------------------------------------------------------------------
echo Adding segmented images...

python3 add_augmented.py --exp $exp_name --pos $positive_label --agu $agu_folder
...
python3 increase_fold.py --exp $exp_name --pos $positive_label
